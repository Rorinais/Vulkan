...
public:
	...
	void setDepthStencilState(DepthStencil depthStencil, bool enable = false);
	...
	Pipeline::Config  getPipelineStateConfig() { return mPipelineStateConfig; }
	PipelineLayout::Ptr getPipelineLayout() { return mPipelineLayout; }
	RenderPass::Ptr getRenderPass() { return mRenderPass; }
	Dynamic getDynamic() { return mPipelineStateConfig.dynamicState; }

private:
	Config mPipelineStateConfig;
