...
public:
	...
	void bindDescriptorSets(const VkPipelineLayout& pipelineLayout, const std::vector<VkDescriptorSet>& descriptorSets);

	void setViewport(const VkExtent2D& extent, bool isOpenglCoord=false);
